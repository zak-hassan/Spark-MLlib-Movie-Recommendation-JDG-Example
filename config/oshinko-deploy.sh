...
DEFAULT_OSHINKO_REST_IMAGE=docker.io/radanalyticsio/oshinko-rest
DEFAULT_OSHINKO_WEB_IMAGE=docker.io/radanalyticsio/oshinko-webui
DEFAULT_PYSPARK_IMAGE=docker.io/radanalyticsio/radanalytics-pyspark
...
docker tag $DEFAULT_OSHINKO_REST_IMAGE $REGISTRY/$PROJECT/oshinko-rest
docker push $REGISTRY/$PROJECT/oshinko-rest
docker tag  $DEFAULT_OSHINKO_WEB_IMAGE $REGISTRY/$PROJECT/oshinko-webui
docker push $REGISTRY/$PROJECT/oshinko-webui
docker tag  $DEFAULT_PYSPARK_IMAGE $REGISTRY/$PROJECT/radanalytics-pyspark
